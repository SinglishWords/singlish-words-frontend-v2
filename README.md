...
| 12      | Check that a legend describing graph visualisation features can be seen on the Visualise Page                                           | 1. Head to the "Visualise page".<br>2. Verify that a legend describing graph visualisation features can be seen on the page.                                                                                                                                                                                                                                                                                                                                                                                                                          |
